...
namespace WebApplication1.Controllers
{
    public class EmployesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeID,AdrCourriel,Prenom,Nom")] Employe employe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeID,AdrCourriel,Prenom,Nom")] Employe employe)
        {
