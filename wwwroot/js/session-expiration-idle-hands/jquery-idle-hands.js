(function ($) {
    $.idleHands = function (userSettings) {
        ...
        let defaultSettings = {
            ...
            dialogMessage: 'Votre session est sur le point d\'expirer en raison de votre inactivité.\n Voulez-vous rester?',
            dialogTimeRemainingLabel: 'Temps restant',
            dialogTitle: 'Avertissement d\'expiration de session',
            documentTitle: null,
            heartbeatCallback: null,
            heartbeatUrl: window.location.href,
            heartRate: 0,
            inactivityLogoutUrl: 'https://localhost:44396/',
            inactivityDialogDuration: 60,
            localStoragePrefix: null,
            logoutNowButtonText: 'Se déconnecter',
            manualLogoutUrl: null,
            maxInactivitySeconds: 900,
            stayLoggedInButtonText: 'Oui'
        };
